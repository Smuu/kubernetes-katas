...
class MyServer(BaseHTTPRequestHandler):
    def do_GET(self):
        if self.path == "/livez":
            ...
            self.wfile.write(bytes("<p>During you fixed the problems your Dev-Team released a new version. Update the application to v1.0.0</p>", "utf-8"))
...
if __name__ == "__main__":
    ...
    logging.error("Could not start webserver.")
